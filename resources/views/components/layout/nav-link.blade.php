...
? 'inline-flex items-center px-1 pt-1 border-b-2 border-amber-500 text-sm font-medium leading-5 text-gray-900
focus:outline-none focus:border-amber-700 transition duration-150 ease-in-out'
