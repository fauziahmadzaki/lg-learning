...
'Paket Bimbel' => route('branch.packages.index', $branch),
];
@endphp

<x-app-layout :breadcrumbs="$breadcrumbs">
    <x-slot name="pageTitle">Daftar Paket Belajar - {{ $branch->name }}</x-slot>
    ...
    <div x-data="{ 
            ...
            async performSearch() {
                ...
                try {
                    // Route Branch
                    const response = await fetch(`{{ route('branch.packages.index', $branch) }}?${params.toString()}`, {
        ...
        <div id="package-list-container">
            @include('branch.package._list', ['branch' => $branch])
        </div>
