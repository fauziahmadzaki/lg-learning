...
<x-app-layout :breadcrumbs="$breadcrumbs">
    <x-slot name="pageTitle">Data Siswa - {{ $branch->name }}</x-slot>
    ...
    <div x-data="{ 
            ...
            async performSearch() {
                ...
                try {
                    // Send to Branch Route
                    const response = await fetch(`{{ route('branch.students.index', $branch) }}?${params.toString()}`, {
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            ...
            <div class="flex flex-col gap-4 w-full">
                ...
                {{-- Row 2: Filters (Removed Branch Filter) --}}
            ...
            {{-- Button --}}
            <a href="{{ route('branch.students.create', $branch) }}">
        ...
        <div id="student-list-container">
            @include('branch.student._list', ['branch' => $branch])
        </div>
