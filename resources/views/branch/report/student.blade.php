<x-app-layout :breadcrumbs="['Laporan Siswa' => route('branch.reports.students', $branch)]">
    <x-slot name="pageTitle">Laporan Data Siswa - {{ $branch->name }}</x-slot>
    ...
    <div x-data>
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Laporan lengkap data siswa di {{ $branch->name }}.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
            <form method="GET" action="{{ route('branch.reports.students', $branch) }}" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
