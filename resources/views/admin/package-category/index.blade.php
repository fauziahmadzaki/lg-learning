...
<x-app-layout :breadcrumbs="$breadcrumbs">
    ...
    <div class="max-w-7xl mx-auto" x-data="{ showDeleteModal: false, deleteUrl: '' }">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <button @click="showDeleteModal = true; deleteUrl = '{{ route('admin.package-categories.destroy', $category) }}'" class="text-red-600 hover:text-red-900">Hapus</button>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Data kategori akan dihapus permanen. Apakah Anda yakin?
                                    </p>
                                </div>
                            </div>
                        </div>
