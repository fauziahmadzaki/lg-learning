<x-landing-layout :settings="$settings" title="Beranda">
    ...
    <section id="home" class="relative pt-28 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-white">
        ...
        {{-- Blobs --}}
        <div class="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-yellow-100 rounded-full blur-3xl opacity-50">
        </div>
        <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 bg-orange-100 rounded-full blur-3xl opacity-50">
        </div>
        ...
        <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)"
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div class="flex-1 text-center lg:text-left">
                    <div
                        class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 border border-orange-100 text-orange-600 font-semibold text-sm mb-6">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                        <a href="/paket"
                            class="px-8 py-4 rounded-xl bg-gradient-to-r from-orange-500 to-yellow-500 text-white font-bold shadow-xl shadow-orange-200 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                            {{ $settings['hero_button_text'] ?? 'Pilih Paket Belajar' }}
                        </a>
                        <a href="#about"
                            class="px-8 py-4 rounded-xl bg-white border border-gray-200 text-gray-700 font-bold hover:bg-gray-50 hover:border-gray-300 transition-all duration-300">
                    ...
                    <div
                        ...
                        <p>Dipercaya oleh <span class="text-gray-900 font-bold">{{ $stats['students'] }}+ Siswa</span>
                        </p>
                    </div>
                </div>
                ...
                <div class="flex-1 relative">
                    <div
                        class="relative z-10 bg-gradient-to-br from-orange-100 to-yellow-50 rounded-3xl p-4 rotate-3 transform hover:rotate-0 transition duration-500">
                        <img src="{{ isset($settings['hero_image']) ? (str_contains($settings['hero_image'], 'http') ? $settings['hero_image'] : asset('storage/' . $settings['hero_image'])) : 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80' }}"
                            alt="Students Learning" class="rounded-2xl shadow-lg w-full object-cover h-[500px]">
                        ...
                        <div class="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl flex items-center gap-3 animate-bounce"
                            ...
                            <div>
                                <p class="text-xs text-gray-500 font-bold uppercase">
                                    {{ $settings['hero_badge_title'] ?? 'Hasil Terjamin' }}</p>
                                <p class="text-lg font-bold text-gray-800">
                                    {{ $settings['hero_badge_subtitle'] ?? 'Nilai Naik' }}</p>
                            </div>
                        </div>
                    </div>
                    {{-- Decorative Elements --}}
                    <div class="absolute top-10 -right-10 text-yellow-400 text-6xl opacity-50 animate-pulse">✨</div>
                    <div class="absolute bottom-20 -right-5 w-24 h-24 bg-orange-500 rounded-full opacity-10 blur-xl">
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- STATS SECTION --}}
    <section class="py-12 bg-gray-50 border-y border-gray-100" x-data="{ shown: false }"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 ease-out transform"
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center" x-data="{
                    items: [
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-12">
                    <div class="text-left">
                        ...
                        <h2 class="text-3xl font-extrabold text-gray-900 mt-2 sm:text-4xl">
                            {{ $settings['about_title'] ?? 'Mengapa Memilih L-G Learning?' }}</h2>
                        <p class="mt-4 text-lg text-gray-500 leading-relaxed">
                            {{ $settings['about_description'] ?? 'Kami bukan sekadar bimbel biasa. Kami adalah partner sukses akademik Anda dengan pendekatan yang lebih personal, fleksibel, dan terukur.' }}
                        </p>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex gap-4">
                            <div
                                class="flex-shrink-0 w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center text-orange-600">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-1">
                                    {{ $settings['feature_1_title'] ?? 'Metode Personal' }}</h3>
                        ...
                        <div class="flex gap-4">
                            <div
                                class="flex-shrink-0 w-12 h-12 bg-yellow-100 rounded-xl flex items-center justify-center text-yellow-600">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-1">
                                    {{ $settings['feature_2_title'] ?? 'Tutor Selektif' }}</h3>
                                <p class="text-gray-500 text-sm">
                        ...
                        <div class="flex gap-4">
                            <div
                                class="flex-shrink-0 w-12 h-12 bg-indigo-100 rounded-xl flex items-center justify-center text-indigo-600">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-900 mb-1">
                                    {{ $settings['feature_3_title'] ?? 'Laporan Berkala' }}</h3>
                                <p class="text-gray-500 text-sm">
                ...
                <div class="flex justify-center lg:justify-end relative">
                    <div
                        class="absolute inset-0 bg-orange-50 rounded-full filter blur-3xl opacity-30 transform scale-110">
                    </div>
                    <div class="relative bg-white p-8 rounded-3xl shadow-2xl border border-gray-100 max-w-sm w-full animate-bounce-slow"
                        style="animation-duration: 6s;">
                        <img src="{{ asset('img/image.png') }}" alt="L-G Learning Logo"
    ...
    {{-- PACKAGES SECTION --}}
    <section id="packages" class="py-20 bg-orange-50/50" x-data="{ shown: false }"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 ease-out transform"
            ...
            <div class="text-center mb-20">
                ...
                <p class="mt-4 max-w-2xl mx-auto text-xl text-gray-500">Investasi terbaik untuk masa depan buah hati
                    Anda.</p>
            </div>
                ...
                <div
                    ...
                    <div class="h-48 overflow-hidden relative group">
                        ...
                        <div class="absolute top-4 left-4 flex gap-2">
                            <span
                                class="inline-block px-3 py-1 bg-white/90 backdrop-blur-sm text-orange-600 text-xs font-bold rounded-full uppercase tracking-wider shadow-sm">{{ $package->category }}</span>
                            <span
                                class="inline-block px-3 py-1 bg-white/90 backdrop-blur-sm text-blue-600 text-xs font-bold rounded-full uppercase tracking-wider shadow-sm">{{ $package->packageCategory->name }}</span>
                        </div>
                    </div>
                    ...
                    <div class="p-6 pb-0 flex-1">
                        ...
                        <p class="text-sm text-gray-500 line-clamp-2 mb-6">
                            {{ $package->description ?? 'Paket belajar intensif dengan materi lengkap.' }}</p>
                    ...
                    <div class="p-6 pt-0 mt-auto flex gap-3">
                        <a href="{{ route('packages.show', $package->slug ?? $package->id) }}"
                            class="flex-1 py-3 px-4 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl text-center hover:bg-gray-50 transition text-sm">
                            Detail
                        </a>
                        <a href="{{ route('packages.register', $package->slug ?? $package->id) }}"
                            class="flex-1 py-3 px-4 bg-orange-500 text-white font-bold rounded-xl text-center hover:bg-orange-600 shadow-md shadow-orange-200 transition text-sm">
                            Daftar
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-12 text-center">
                <a href="{{ route('packages.index') }}" class="text-orange-600 font-bold hover:underline">Lihat Semua
                    Paket &rarr;</a>
            </div>
        </div>
    </section>
    ...
    <section id="gallery" class="py-20 bg-white overflow-hidden" x-data="{ shown: false }"
        x-intersect.threshold.10.once="shown = true">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 ease-out transform"
            :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'">
            ...
            <div x-data="{ 
                ...
                }" x-init="setInterval(() => next(), 5000)" class="relative">
                ...
                <div class="relative max-w-5xl mx-auto h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                    <template x-for="(slide, index) in slides" :key="index">
                        <div x-show="activeSlide === index"
                            ...
                            x-transition:leave-end="opacity-0 -translate-x-full" class="absolute inset-0 w-full h-full">
                            ...
                            {{-- Content Overlay --}}
                            <div
                                class="absolute inset-x-0 bottom-0 p-8 md:p-16 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
                                <div class="max-w-3xl mx-auto text-center transform transition-all duration-500"
                                    ...
                                    <span x-text="slide.type"
                                        class="inline-block py-1 px-3 rounded-full bg-orange-500 text-white text-xs font-bold mb-4 uppercase tracking-wider"></span>
                                    <h3 x-text="slide.title" class="text-3xl md:text-5xl font-bold text-white mb-4">
                                    </h3>
                                    <p x-text="slide.description"
                                        class="text-lg md:text-xl text-gray-200 leading-relaxed"></p>
                                </div>
                            </div>
                        </div>
                    </template>
                    ...
                    {{-- Navigation Buttons --}}
                    <button @click="prev()"
                        class="absolute z-10 top-1/2 left-4 md:left-8 -translate-y-1/2 w-12 h-12 rounded-full bg-white/20 backdrop-blur-md hover:bg-orange-500 text-white flex items-center justify-center transition hover:scale-110 focus:outline-none shadow-lg border border-white/30">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button @click="next()"
                        class="absolute z-10 top-1/2 right-4 md:right-8 -translate-y-1/2 w-12 h-12 rounded-full bg-white/20 backdrop-blur-md hover:bg-orange-500 text-white flex items-center justify-center transition hover:scale-110 focus:outline-none shadow-lg border border-white/30">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- CTA SECTION --}}
        <section class="py-20 relative overflow-hidden mt-20" x-data="{ shown: false }"
            x-intersect.threshold.10.once="shown = true">
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center transition-all duration-700 ease-out transform"
                ...
                <p class="text-xl text-orange-100 mb-10 max-w-2xl mx-auto">
                    Jangan tunda prestasi anak Anda. Bergabunglah dengan ratusan siswa lainnya yang telah merasakan
                    manfaat belajar di L-G Learning.
                </p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="/paket"
                        class="px-8 py-4 bg-white text-orange-600 font-bold rounded-xl shadow-lg hover:bg-gray-50 transition transform hover:scale-105">
                        Daftar Sekarang
                    </a>
                    <a href="/kontak"
                        class="px-8 py-4 bg-orange-700 bg-opacity-30 text-white font-bold rounded-xl border border-orange-400 hover:bg-opacity-50 transition">
                        Hubungi Kami
                    </a>
                </div>
            </div>
        ...
        {{-- CONTACT SECTION --}}
        <section id="contact" class="py-20 bg-white" x-data="{ shown: false }"
            x-intersect.threshold.10.once="shown = true">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 ease-out transform"
                :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    <div>
                        ...
                        <p class="text-gray-500 mb-8 text-lg">
                            Tim kami siap membantu Anda. Silakan hubungi kami melalui kontak di bawah atau kunjungi
                            kantor kami.
                        </p>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start gap-4">
                                <div
                                    class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center text-orange-600 flex-shrink-0">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z">
                                        </path>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500">
                                        {{ $settings['contact_address'] ?? 'Jl. Pendidikan No. 123, Jakarta Selatan' }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-4">
                                <div
                                    class="w-12 h-12 bg-yellow-100 rounded-lg flex items-center justify-center text-yellow-600 flex-shrink-0">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500">{{ $settings['contact_whatsapp'] ?? '0812-3456-7890' }}
                                        <br> {{ $settings['contact_email'] ?? 'info@lglearning.com' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="bg-white rounded-xl border border-gray-100 overflow-hidden">
                                <button
                                    ...
                                    <svg class="w-5 h-5 text-gray-400 transform transition-transform duration-200"
                                        :class="{ 'rotate-180': activeAccordion === {{ $index }} }" fill="none"
