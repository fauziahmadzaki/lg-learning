            ...
            <div class="flex flex-col lg:flex-row gap-12 items-start">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex flex-wrap gap-2 mb-6">
                        <div
                            class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 text-orange-600 font-bold text-xs uppercase tracking-wider">
                            {{ $package->category ?? 'Paket Belajar' }}
                        </div>
                        <div
                            class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100 text-blue-600 font-bold text-xs uppercase tracking-wider">
                    ...
                    <div class="flex items-center gap-8 mb-8 text-gray-600">
                        <div class="flex items-center gap-2">
                            <span class="bg-blue-100 text-blue-600 p-2 rounded-lg"><svg class="w-5 h-5" fill="none"
                    ...
                    <div class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm mb-8">
                        ...
                        <ul class="space-y-4">
                            ...
                            <li
                                class="flex items-start gap-4 p-4 rounded-xl hover:bg-orange-50 transition border border-transparent hover:border-orange-100">
                                ...
                                <div>
                                    <span class="text-gray-900 font-bold block mb-1">Benefit #{{ $loop->iteration
                                        }}</span>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                        <div class="p-8">
                            ...
                            <a href="{{ route('packages.register', $package->slug ?? $package->id) }}"
                                class="block w-full py-4 bg-orange-500 text-white font-bold rounded-xl text-center shadow-lg shadow-orange-200 hover:bg-orange-600 hover:scale-[1.02] transition-all duration-300">
                                Daftar Sekarang
                            </a>
